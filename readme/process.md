...
| Code examples | Permitted only when they document the *workflow* (e.g., "run `workspace package build` inside the experiment directory"), not when they advertise a capability. |
