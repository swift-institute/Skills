...
<!-- Detailed review corpus catalogue retained for progressive disclosure. -->
...
cd <swift-forums-review-corpus-checkout>
...
# Per-package use:
.venv/bin/python scripts/characterize_package.py <package-path>
```
