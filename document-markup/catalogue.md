...
description: |
  ...
  Apply when creating HTML, generating PDFs, rendering markdown, or composing with swift-html / swift-pdf / swift-pdf-rendering.
---

<!-- Detailed markup rule catalogue retained for progressive disclosure. -->
