...
<!-- Detailed social-preview catalogue retained for progressive disclosure. -->
...
the package's Workspace-materialized checkout. The tool reads
...
1. Materialize the package through Workspace if it is not already present.
...
swift-institute/Skills/social-preview/
...
2026-07-27 from the retired private `swift-institute/Scripts` repo, so the
