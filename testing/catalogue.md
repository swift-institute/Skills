...
Local test runs go through the Workspace-owned coordinator
([PKG-BUILD-OWNER]):
...
in the scoped SwiftPM contexts of [PKG-BUILD-TOOLCHAIN] (e.g. [TEST-036]
fresh-build gates, [TEST-037] TSan) also run through the coordinator. Raw SwiftPM
...
**Cross-references**: [MOD-PRODUCT], [CONV-007] (re-export chain and literal conformances)
...
**Cross-references**: [TEST-001], [TEST-009], [TEST-021]
