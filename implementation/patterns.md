...
| ID | Statement | Cross-ref |
|----|-----------|-----------|
| [API-LAYER-001] | Code MUST be designed in layers with no upward dependencies; essential same-layer dependencies MUST form an acyclic semantic graph | [ARCH-LAYER-001] |
